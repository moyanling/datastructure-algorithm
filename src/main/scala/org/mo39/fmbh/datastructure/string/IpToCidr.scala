...
/**
  ...
  *
  * The address "255.0.0.16/32" specifies all addresses with a common prefix of 32 bits to the given address, ie. just 11111111 00000000 00000000 00010000.
  *
  ...
  * }}}
  *
  * @see [[https://leetcode.com/problems/ip-to-cidr/ IpToCidr]]
  * @author mo39.fmbh
  */
