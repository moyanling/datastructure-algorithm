...
/**
  ...
  * }}}
  *
  * "@see [[https://leetcode.com/problems/baseball-game/ Baseball Game]]"
  * "@author mo39.fmbh"
  */
@ProblemSource(LeetCode)
sealed trait BaseballGame {
  def calPoints(ops: Array[String]): Int
}

/**
  * According to LeetCode, both solutions are faster than deprecated Stack.
  */
object BaseballGame extends Enumerable[BaseballGame] {

  /* Uses immutable List as a Stack */
  object Solution0 extends BaseballGame {
  ...
  /* Uses a mutable List as a Stack */
  object Solution1 extends BaseballGame {
