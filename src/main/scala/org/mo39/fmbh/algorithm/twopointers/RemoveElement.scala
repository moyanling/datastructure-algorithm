...
/**
  ...
  * }}}
  *
  * @see [[https://leetcode.com/problems/remove-element/ RemoveElement]]
  * @author mo39.fmbh
  */
...
object RemoveElement extends Enumerable[RemoveElement] {
  case object Solution extends RemoveElement {
    override def removeElement(nums: Array[Int], `val`: Int): Int = partition(nums, _ != `val`)
  }
}
